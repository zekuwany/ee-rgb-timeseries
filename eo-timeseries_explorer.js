...
var rgbTs = require(
  'users/zekuwany/landsat_ndvi_lst:ee-rgb-timeseries/rgb-timeseries.js'); 
...
var appCodeLink = ui.Label({
  ...
  targetUrl: 'https://github.com/zekuwany/ee-rgb-timeseries/blob/main/eo-timeseries_explorer.js'
});
...
//
map.centerObject(ee.Geometry.Point([41.766, 9.23]), 14);
